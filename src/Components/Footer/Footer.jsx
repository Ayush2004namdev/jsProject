        ...
        <div className="footer mt-5">
          <div className="row">
              ...
              <div className="card border-0 bg-transparent">
                <div className="card-body">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <a href="#nothing">DJP Cares</a>
                    </li>
                    <li>
                      <a href="#nothing">DJP Stories</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-12 col-lg d-flex flex-column justify-content-between p-0 m-0">
              <div className="card border-0 bg-transparent">
                <div className="card-body">
                  <h5 className="card-title text-white">Let Us Help You</h5>
                  <ul className="list-unstyled">
                    <li>
                      <a href="#nothing">COVID-19 & DJP </a>
                    </li>
                    <li>
                      <a href="#nothing">Your Account</a>
                    </li>
                    <li>
                      <a href="#nothing">DJP Assitance</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="desktop-section">
                <div className="desktop-original">
                  ...
                  <div className="promise">
                    ...
                    <br /> guarantee for all products at DJP Digital{" "}
                  </div>
                </div>
              </div>
              <div className="desktop-section">
            ...
            <div className="foot_">
              ...
              <div className="foot__">
                <span>©</span>2021-2050 DJP Digital
              </div>
              <div>
                <img
